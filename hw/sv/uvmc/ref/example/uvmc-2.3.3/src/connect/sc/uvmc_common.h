...
// UVMC233_ADDITIONS {
extern void uvmc_enable_trans_mm();
// } UVMC233_ADDITIONS
...
class uvmc_proxy_base
{
  ...
  virtual int x_nb_transport_bw (
    unsigned long long trans_chandle,
    bits_t *bits, uint32 *phase, sc_dt::uint64 *delay );
// UVMC233_ADDITIONS {
  virtual unsigned long long x_trans_mm_alloc();
  virtual void x_trans_mm_free( unsigned long long trans_chandle );
// } UVMC233_ADDITIONS
