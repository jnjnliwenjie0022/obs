...
//
// # Signals from AHB Slave and SLV Commander
// &FORCE("input", "hs0_hready");
// &FORCE("input", "hs0_hresp[1:0]");
// &FORCE("input", "hs0_hrdata[DATA_MSB:0]");
// &FORCE("input", "slv0_base[ADDR_MSB:BASE_ADDR_LSB]");
// &FORCE("input", "slv0_size[3:0]");
//
// for($j = 0; $j < $MST_NUM; ++$j) {
//   &IFDEF("ATCBMC200_AHB_MST${j}");
//   &FORCE("output", "mst${j}_hs0_hready");
//   &FORCE("output", "mst${j}_hs0_hresp[1:0]");
//   &FORCE("output", "mst${j}_hs0_hrdata[DATA_MSB:0]");
//   &FORCE("output", "mst${j}_slv0_base[ADDR_MSB:BASE_ADDR_LSB]");
//   &FORCE("output", "mst${j}_slv0_size[3:0]");
//   &FORCE("input",  "mst${j}_slv0_ack");
//   &FORCE("output", "mst${j}_slv0_grant");
//   &ENDIF("ATCBMC200_AHB_MST${j}");
// }
//
// for($i = 1; $i < $SLV_NUM; ++$i) {
//   &IFDEF("ATCBMC200_AHB_SLV${i}");
//   &FORCE("input", "hs${i}_hready");
//   &FORCE("input", "hs${i}_hresp[1:0]");
//   &FORCE("input", "hs${i}_hrdata[DATA_MSB:0]");
//   &FORCE("input", "slv${i}_base[ADDR_MSB:BASE_ADDR_LSB]");
//   &FORCE("input", "slv${i}_size[3:0]");
//
//   for($j = 0; $j < $MST_NUM; ++$j) {
//     &IFDEF("ATCBMC200_AHB_MST${j}");
//     &FORCE("output", "mst${j}_hs${i}_hready");
//     &FORCE("output", "mst${j}_hs${i}_hresp[1:0]");
//     &FORCE("output", "mst${j}_hs${i}_hrdata[DATA_MSB:0]");
//     &FORCE("output", "mst${j}_slv${i}_base[ADDR_MSB:BASE_ADDR_LSB]");
//     &FORCE("output", "mst${j}_slv${i}_size[3:0]");
//     &FORCE("input",  "mst${j}_slv${i}_ack");
//     &FORCE("output", "mst${j}_slv${i}_grant");
//     &ENDIF("ATCBMC200_AHB_MST${j}");
//   }
//   &ENDIF("ATCBMC200_AHB_SLV${i}");
// }
//
// # Signals from AHB Master and MST Commander
// for($j = 0; $j < $MST_NUM; ++$j) {
//   &IFDEF("ATCBMC200_AHB_MST${j}");
//   &FORCE("input", "hm${j}_hwdata[DATA_MSB:0]");
//   &FORCE("input", "mst${j}_haddr[ADDR_MSB:0]");
//   &FORCE("input", "mst${j}_hburst[2:0]");
//   &FORCE("input", "mst${j}_hprot[3:0]");
//   &FORCE("input", "mst${j}_hsize[2:0]");
//   &FORCE("input", "mst${j}_htrans[1:0]");
//   &FORCE("input", "mst${j}_hwrite");
//
//   for($i = 0; $i < $SLV_NUM; ++$i) {
//     &IFDEF("ATCBMC200_AHB_SLV${i}");
//     &FORCE("output", "hm${j}_slv${i}_hwdata[DATA_MSB:0]");
//     &FORCE("output", "mst${j}_slv${i}_haddr[ADDR_MSB:0]");
//     &FORCE("output", "mst${j}_slv${i}_hburst[2:0]");
//     &FORCE("output", "mst${j}_slv${i}_hprot[3:0]");
//     &FORCE("output", "mst${j}_slv${i}_hsize[2:0]");
//     &FORCE("output", "mst${j}_slv${i}_htrans[1:0]");
//     &FORCE("output", "mst${j}_slv${i}_hwrite");
//     &FORCE("input",  "mst${j}_slv${i}_sel");
//     &FORCE("output", "mst${j}_slv${i}_req");
//     &ENDIF("ATCBMC200_AHB_SLV${i}");
//   }
//   &ENDIF("ATCBMC200_AHB_MST${j}");
// }
...
//: `ifdef ATCBMC200_AHB_SLV${i}
// for($j = 0; $j < $MST_NUM; ++$j) {
//:   `ifdef ATCBMC200_MST${j}_SLV${i}
//:   assign mst${j}_hs${i}_hrdata  = hs${i}_hrdata; 
//:   assign mst${j}_hs${i}_hready  = hs${i}_hready;
//:   assign mst${j}_hs${i}_hresp   = hs${i}_hresp;
//:   assign mst${j}_slv${i}_base   = slv${i}_base;
//:   assign mst${j}_slv${i}_size   = slv${i}_size;
//:   assign mst${j}_slv${i}_grant  = mst${j}_slv${i}_ack;
//
//:   assign hm${j}_slv${i}_hwdata  = hm${j}_hwdata; 
//:   assign mst${j}_slv${i}_haddr  = mst${j}_haddr;
//:   assign mst${j}_slv${i}_hburst = mst${j}_hburst;
//:   assign mst${j}_slv${i}_hprot  = mst${j}_hprot;
//:   assign mst${j}_slv${i}_hsize  = mst${j}_hsize;
//:   assign mst${j}_slv${i}_htrans = mst${j}_htrans;
//:   assign mst${j}_slv${i}_hwrite = mst${j}_hwrite;
//
//:   assign mst${j}_slv${i}_req    = mst${j}_slv${i}_sel;
//:   `else
//:      `ifdef ATCBMC200_AHB_MST${j}
//:      assign mst${j}_hs${i}_hrdata  = {DATA_WIDTH{1'b0}}; 
//:      assign mst${j}_hs${i}_hready  = 1'b0;
//:      assign mst${j}_hs${i}_hresp   = 2'h0;
//:      assign mst${j}_slv${i}_base   = {(ADDR_WIDTH-BASE_ADDR_LSB){1'b0}};
//:      assign mst${j}_slv${i}_size   = 4'h0;
//:      assign mst${j}_slv${i}_grant  = 1'b0;
//
//:      assign hm${j}_slv${i}_hwdata  = {DATA_WIDTH{1'b0}};
//:      assign mst${j}_slv${i}_haddr  = {ADDR_WIDTH{1'b0}};
//:      assign mst${j}_slv${i}_hburst = 3'h0;
//:      assign mst${j}_slv${i}_hprot  = 4'h0;
//:      assign mst${j}_slv${i}_hsize  = 3'h0;
//:      assign mst${j}_slv${i}_htrans = 2'h0;
//:      assign mst${j}_slv${i}_hwrite = 1'b0;
//:      assign mst${j}_slv${i}_req    = 1'b0;
//:      `endif
//:   `endif
// }
//: `endif // ATCBMC200_AHB_SLV${i}
