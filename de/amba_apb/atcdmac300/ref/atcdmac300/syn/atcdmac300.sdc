...
set_input_delay -max $axi_input_delay -clock ACLK [get_ports m*_bid*]
...
set_input_delay -max $axi_input_delay -clock ACLK [get_ports m*_rid*]
...
set_output_delay -max $axi_output_delay -clock ACLK [get_ports m*_awid*]
...
set_output_delay -max $axi_output_delay -clock ACLK [get_ports m*_arid*]
