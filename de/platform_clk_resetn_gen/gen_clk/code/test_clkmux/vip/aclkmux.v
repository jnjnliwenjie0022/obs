...
generate
if (ASYNC_CLK_MUX == "no") begin : gen_sync_clkmux
...
generate
if (ASYNC_CLK_MUX == "only_gck") begin : gen_only_gck

    wire	gated_clk0;
    wire	gated_clk1;

    assign clk0_en = ~select;
    assign clk1_en = select;
...
generate
if (ASYNC_CLK_MUX == "only_mux") begin : gen_only_mux

    assign clk0_en = ~select;
    assign clk1_en = select;

    assign clk_out = select ? clk_in1 : clk_in0;
end
endgenerate
