// This module is used in ae350_clkgen

//pd_clk_ctrl pd_clk(.clk_en(), .clk(), .rstn(), .clock_unstable(clock_unstable),
//		 	.frq_scale_ack(pcs_frq_scale_ack), .frq_scale_req(pcs_frq_scale_req), .frq_scale(pcs_frq_scale));
module pd_clk_ctrl (
input		clk,
input		rstn,
