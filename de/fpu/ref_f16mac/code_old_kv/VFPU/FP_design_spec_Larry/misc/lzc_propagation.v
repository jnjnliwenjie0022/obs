...
l4_mux_mask   = ~f1_s_lz_num[3];
l3_mux_mask   = ~f1_s_lz_num[2];
l2_mux_mask   = {~f1_s_lz_num[1] & ~f1_s_lz_num[0], ~f1_s_lz_num[1], ~f1_s_lz_num[0], 1'b1};
//l1_mux_mask   = {~f1_s_lz_num[0], 1'b1};
...
l4_mux_sticky_0 = |bit[23:16];
l4_mux_sticky_1 = |bit[ 7: 0];

l3_mux_sticky_0 = (f1_s_lz_num[4:4] == 1'b0) ? |bit[27:24] : |bit[11: 8] ;
l3_mux_sticky_1 = (f1_s_lz_num[4:4] == 1'b0) ? |bit[19:16] : |bit[ 3: 0] ; 


l2_mux_sticky_0 = (f1_s_lz_num[4:3] == 2'b00) ? |bit[29:28] :
