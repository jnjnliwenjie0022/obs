//============================================================================
// @(#) $Id: uvmc_xl_config.h 2046 2023-09-29 20:51:01Z jstickle $
//============================================================================
...
class uvmc_xl_config_base : public tlm::tlm_extension<uvmc_xl_config_base> {
  private:
  ...
  public:
    ...
    void copy_from_sideband_only( tlm::tlm_extension_base const &ext );
...
class uvmc_xl_config : public uvmc_xl_config_base {
  ...
  protected:
    ...
    tlm::tlm_generic_payload m_query_trans, m_update_trans;
  ...
  public:
    ...
    {   m_query_trans.set_read(); // is_read=1 to indicate static config query.
        ...
        m_query_trans.set_data_length( 0 ); // Specify as 0 for config
                                            // update/query.
        m_query_trans.set_byte_enable_ptr( (unsigned char *)NULL );
        ...
        m_update_trans.set_data_length( 0 ); // Specify as 0 for config
                                             // update/query.
        m_update_trans.set_byte_enable_ptr( (unsigned char *)NULL );
    ...
    tlm::tlm_generic_payload &query_trans() { return m_query_trans; }
    tlm::tlm_generic_payload &update_trans() { return m_update_trans; }
};
