...
// UVMC233_ADDITIONS {
extern bool uvmc_is_trans_mm_enabled;
// } UVMC233_ADDITIONS
...
// UVMC233_ADDITIONS {
    ...
    svSetScope(uvmc_pkg_scope);
    result = C2SV_nb_transport_fw(
        m_x_id, trans_chandle, m_bits, &ph, delay_in_bits);
// } UVMC233_ADDITIONS
...
// UVMC233_ADDITIONS {
    typename TYPES::tlm_payload_type *x_trans_p;
// } UVMC233_ADDITIONS
...
// UVMC233_ADDITIONS {
    ...
    if( uvmc_is_trans_mm_enabled ){
        typename TYPES::tlm_payload_type *t
            = reinterpret_cast<typename TYPES::tlm_payload_type *>(
                trans_chandle );
        if( t != NULL ) x_trans_p = t;
        else x_trans_p = &x_trans;
    }
    else x_trans_p = &x_trans;
// } UVMC233_ADDITIONS

    CVRT::do_unpack(*x_trans_p,*proxy_type::m_packer);
    tlm_sync_enum result;
    result = (*m_target_skt)->nb_transport_bw(*x_trans_p,x_phase,x_delay);
    *phase = x_phase;
    ...
    CVRT::do_pack(*x_trans_p,*proxy_type::m_packer);
#ifdef UVMC23_ADDITIONS // {
